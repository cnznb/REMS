...
tokenizer = AutoTokenizer.from_pretrained("D:/pythonProject/Cbert/CodeGPT-small-java")
model = AutoModel.from_pretrained("D:/pythonProject/Cbert/CodeGPT-small-java")
...
if __name__ == '__main__':
    ...
    for project in files:
        ...
        output_fn = project_list + '/' + project + '/bert_vec/CodeGPT_vec.csv'
