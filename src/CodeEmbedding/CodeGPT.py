...
tokenizer = AutoTokenizer.from_pretrained("D:/pythonProject/Cbert/CodeGPT-small-java-adaptedGPT2")
model = AutoModel.from_pretrained("D:/pythonProject/Cbert/CodeGPT-small-java-adaptedGPT2")
...
if __name__ == '__main__':
    ...
    for project in files:
        ...
        output_fn = project_list + '/' + project + '/bert_vec/CodeGPT2_vec.csv'
        with open(output_fn, 'w+', encoding="utf-8", newline='') as wf:
            cw = csv.writer(wf)
            for data in vecs:
                cw.writerow(data)
        # json.dump(data_vec, output_file)
        # output_file.close()
