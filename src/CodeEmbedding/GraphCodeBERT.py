...
tokenizer = AutoTokenizer.from_pretrained(r"../../REMS/model/graphcodebert-base")
model = AutoModel.from_pretrained(r"../../REMS/model/graphcodebert-base")
    ...
    if len(codes) != 0:
        ...
        for line in codes:
            ...
            if line in ['\n', '\r\n'] or line.strip() == "":
                ...
                vecs.append(vec)
        # 将各行代码嵌入向量写入文件
        output_fn = set_path + '/code_embedding/GraphCodeBERT_vec.csv'
