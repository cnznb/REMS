...
tokenizer = AutoTokenizer.from_pretrained("D:/pythonProject/Cbert/cotext-2-cc")
model = AutoModel.from_pretrained("D:/pythonProject/Cbert/cotext-2-cc")
...
if __name__ == '__main__':
    ...
    for project in files:
        ...
        output_fn = project_list + '/' + project + '/bert_vec/cotext_vec.csv'
